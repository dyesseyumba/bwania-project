...
var app = angular.module("bwania", [
        "ngRoute", "ngCookies", "bwaniaAnimations", "customServices", "ui.bootstrap",
    ...
    .config([
        ...
        function($routeProvider, $httpProvider, facebookProvider, $authProvider) {
            ...
            //COnfigureation du client facebook pour satelizer
            $authProvider.facebook({
                clientId: "1414324985471775"
            });
            $authProvider.oauth2({
                url: "http://www.thinktecture.com",
                name: "Implicit Clients",
                scope: ["openid","profile","email","offline_access","read","write","forbidden"],
                clientId: "implicitclient",
                authorizationEndpoint: "http://localhost:27573/identity/connect/authorize",
                responseType: ["code", "token", "id_token", "id_token token", "code id_token", "code token", "code id_token token"]                         
            });
        }
    ]);
