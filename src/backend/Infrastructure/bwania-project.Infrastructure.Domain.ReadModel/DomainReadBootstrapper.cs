// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DomainReadBootstrapper.cs" company="Bwania development team">
...
{
    public class DomainReadBootstrapper
    {
        /// <summary>
        ...
        {
            container.Register<IDocumentReadEngine, IDocumentReadEngine>();
        }
    }
}